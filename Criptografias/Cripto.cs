...
namespace Criptografias
{
    ...
    public class Cripto
    {
        ...
        private void SetIV()
        {
            switch (_cryptProvider)
            {
                case CryptProvider.Rijndael:
                    _algorithm.IV = new byte[] { 0xcd, 0x6f, 0x13, 0x35, 0xc2, 0x4b, 0xf9, 0x5, 0x46, 0x2e, 0x9c, 0xf, 0xea, 0xa8, 0x73, 0xcc };
                    break;
        ...
        /// <summary> Construtor com o tipo de criptografia a ser usada Você pode escolher o tipo pelo Enum chamado CryptProvider. </summary>
        /// <param name="cryptProvider">Tipo de criptografia.</param>
        public Cripto(CryptProvider cryptProvider, string key)
        {
            _key = key;
